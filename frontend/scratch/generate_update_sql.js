...
for (const cat of CATEGORIES) {
  sql += `UPDATE ${cat} SET ans = (ARRAY['SATISFACTORY', 'UNSATISFACTORY', 'GOOD', 'NOT SEEN'])[floor(random() * 4 + 1)] WHERE vessel_id = 'b4871f10-60cc-4a4a-a49b-bb22b290f206';\n`;
}

fs.writeFileSync('D:/inspection/frontend/scratch/update_random_ans.sql', sql);
